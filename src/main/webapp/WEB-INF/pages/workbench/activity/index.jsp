...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#importActivityBtn").click(function () {
			 //alert("ok");
			//获取file元素
			var activiyFileName=$("#activityFile").val();
			//alert(activiyFileName);
			//获取文件的后缀名a.b.xls
			var suffix=activiyFileName.substr(activiyFileName.lastIndexOf(".")+1).toUpperCase(); //18 .xls 19 xls
			//alert(suffix);
			if(suffix!='XLS'){
				alert("只支持后缀名为XLS的文件");
				return;
